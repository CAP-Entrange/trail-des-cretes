      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <div className="space-y-6 text-lg sm:text-xl leading-relaxed text-foreground/80">
            <p>
              <span className="font-bold text-primary">CAP Entrange</span> vous propose de courir dans les pas des défenseurs de la Ligne Maginot. Bien plus qu'une simple compétition sportive, le Trail des Crêtes est une immersion au cœur d'un patrimoine historique exceptionnel.
            </p>
            <p>
